...
var guiders = (function($) {
  ...
  guiders._htmlSkeleton = [
    ...
    "    <p class='guiders_description'></p>",//by yusuf guiders_close div moved to up from here
  ...
  guiders._attach = function(myGuider) {
	...
	//added by yusuf
	myGuider.originalPosition = myGuider.originalPosition || myGuider.position;
	myGuider.position = myGuider.originalPosition;
	for(var inc = 6, pos = myGuider.position;inc<12 && (inc==6 || top<0 || left<0) ;pos = ((myGuider.originalPosition+inc)%13)+1, inc+=3){
    myGuider.position = pos;
	top = base.top;
    left = base.left;
	//added by yusuf
  ...
  guiders._styleArrow = function(myGuider) {
    ...
    myGuiderArrow.removeClass().addClass("guiders_arrow").addClass(newClass[position]);
